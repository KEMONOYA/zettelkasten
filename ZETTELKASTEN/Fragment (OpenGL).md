...
- *Color data is assigned to a fragment during the fragment shader stage. After this, a fragment may very well still be discarded during its execution of the fragment shader, or during later tests. Only surviving fragments after all tests contribute their colors to the screen and become full-fledged rendered pixels.*
