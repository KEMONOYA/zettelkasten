...
Euler's theorem then states that if $f(x_{1},x_2,...,x_n)$ is positively homogeneous of degree $k$, and continuously differentiable in some open subset of $\mathbb R^n$, then
